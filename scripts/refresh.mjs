...
const [spotify, github, canvasapi] = await Promise.all([
...
await writeJSON('data/activity.json', { version: 1, generatedAt: now, spotify, github, canvasapi });
for (const [name, feed] of Object.entries({ spotify, github, canvasapi })) {
